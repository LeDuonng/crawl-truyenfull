        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if chapter_div:
                    ...
                    print("Không tìm thấy div chapter-c")
                    return None
...
def fetch_chapter(chapter_number, base_url):
    ...
    if content:
        return (chapter_number, clean_text(content))
    else:
        ...
        while True:
            ...
            for future in concurrent.futures.as_completed(future_to_chapter):
                ...
                try:
                    ...
                    batch_results[chap_num] = result[1]
                except Exception as e:
                    print(f"Lỗi với chương {chap_num}: {e}")
                    batch_results[chap_num] = None
            ...
            for chap in range(chapter_number, chapter_number + batch_size):
                ...
                if content is not None:
                    ...
                    print(f"Không tìm thấy chương {chap}. Dừng crawl.")
                    return chapters
